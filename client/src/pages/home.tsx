...
const Home = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <Helmet>
        <title>VividPlate — Beautiful Digital Menus for Restaurants</title>
        <meta name="description" content="VividPlate helps restaurants create stunning digital menus accessible via QR codes and web links. Free to start. Premium plans from $25/month." />
        <meta property="og:title" content="VividPlate — Beautiful Digital Menus for Restaurants" />
        <meta property="og:description" content="Create, customize, and share your restaurant menu digitally. QR code generation included." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.vividplate.com/" />
        <link rel="canonical" href="https://www.vividplate.com/" />
      </Helmet>
      <CustomerHeader 
