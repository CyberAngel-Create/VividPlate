...
const Login = () => (
  <div style={{ minHeight: "100vh", background: "linear-gradient(135deg, #fef3c7 0%, #ffffff 100%)", display: "flex", alignItems: "center", justifyContent: "center" }}>
    <div style={{ backgroundColor: "white", padding: "2rem", borderRadius: "0.5rem", boxShadow: "0 10px 15px -3px rgba(0, 0, 0, 0.1)", maxWidth: "400px", width: "100%" }}>
      <h2 style={{ color: "#f59e0b", fontSize: "1.5rem", fontWeight: "bold", marginBottom: "1.5rem", textAlign: "center" }}>Restaurant Login</h2>
      <form>
        <div style={{ marginBottom: "1rem" }}>
          <label style={{ display: "block", color: "#374151", fontSize: "0.875rem", fontWeight: "500", marginBottom: "0.25rem" }}>Username</label>
          <input type="text" style={{ width: "100%", padding: "0.5rem", border: "1px solid #d1d5db", borderRadius: "0.25rem" }} placeholder="Enter username" />
        </div>
        <div style={{ marginBottom: "1.5rem" }}>
          <label style={{ display: "block", color: "#374151", fontSize: "0.875rem", fontWeight: "500", marginBottom: "0.25rem" }}>Password</label>
          <input type="password" style={{ width: "100%", padding: "0.5rem", border: "1px solid #d1d5db", borderRadius: "0.25rem" }} placeholder="Enter password" />
        </div>
        <button type="submit" style={{ width: "100%", backgroundColor: "#f59e0b", color: "white", padding: "0.75rem", borderRadius: "0.25rem", border: "none", fontWeight: "500", cursor: "pointer" }}>Sign In</button>
      </form>
      <div style={{ textAlign: "center", marginTop: "1rem" }}>
        <a href="/" style={{ color: "#6b7280", fontSize: "0.875rem", textDecoration: "none" }}>← Back to Home</a>
      </div>
    </div>
  </div>
);
...
const AdminLogin = () => (
  <div style={{ minHeight: "100vh", background: "linear-gradient(135deg, #fef3c7 0%, #ffffff 100%)", display: "flex", alignItems: "center", justifyContent: "center" }}>
    <div style={{ backgroundColor: "white", padding: "2rem", borderRadius: "0.5rem", boxShadow: "0 10px 15px -3px rgba(0, 0, 0, 0.1)", maxWidth: "400px", width: "100%" }}>
      <h2 style={{ color: "#dc2626", fontSize: "1.5rem", fontWeight: "bold", marginBottom: "1.5rem", textAlign: "center" }}>Admin Login</h2>
      <form>
        <div style={{ marginBottom: "1rem" }}>
          <label style={{ display: "block", color: "#374151", fontSize: "0.875rem", fontWeight: "500", marginBottom: "0.25rem" }}>Username</label>
          <input type="text" style={{ width: "100%", padding: "0.5rem", border: "1px solid #d1d5db", borderRadius: "0.25rem" }} placeholder="Enter admin username" />
        </div>
        <div style={{ marginBottom: "1.5rem" }}>
          <label style={{ display: "block", color: "#374151", fontSize: "0.875rem", fontWeight: "500", marginBottom: "0.25rem" }}>Password</label>
          <input type="password" style={{ width: "100%", padding: "0.5rem", border: "1px solid #d1d5db", borderRadius: "0.25rem" }} placeholder="Enter admin password" />
        </div>
        <button type="submit" style={{ width: "100%", backgroundColor: "#dc2626", color: "white", padding: "0.75rem", borderRadius: "0.25rem", border: "none", fontWeight: "500", cursor: "pointer" }}>Admin Sign In</button>
      </form>
      <div style={{ textAlign: "center", marginTop: "1rem" }}>
        <a href="/" style={{ color: "#6b7280", fontSize: "0.875rem", textDecoration: "none" }}>← Back to Home</a>
      </div>
